<%@ Page Title="Cliente" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="Editar.aspx.cs" Inherits="Editar" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <div class="card">
        ...
        <div class="input">
            <asp:TextBox ID="Email" runat="server" Placeholder=" " />
    ...
    <div class="text-right">
        <% if (isUpdate) { %>
           <asp:Button CssClass="button red" Text="Deletar" ID="deletarBtn" runat="server" onClick="deletarCliente" />
        <% } %>

        <asp:Button CssClass="button" Text="Salvar" runat="server" ID="salvarBtn" onClick="salvarCliente" />
    </div>
</asp:Content>